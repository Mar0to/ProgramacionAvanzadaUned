<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/InicioSesionIniciada.Master" AutoEventWireup="true" CodeBehind="InicioSA.aspx.cs" Inherits="ProgramacionAvanzadaUned.IndexSA" %>
    ...
    <main class="container" id="centrado">
		...
		<section class="row">
			<article class="col">
				...
				<p id="parrafos">Procedimiento quirúrgico electrivo. Ademá se debe realizar debido a sus grandes beneficios. 
					Esto requiere una cuidadosa selección de pacientes a realizar.</p>
            	<asp:Button runat="server" CssClass="boton-ver" Text="Ver" ID="btnCardiologia" OnClick="btnCardiologia_Click"/> 	
			</article>
			<br/>
			<article class="col">
				<br/>
